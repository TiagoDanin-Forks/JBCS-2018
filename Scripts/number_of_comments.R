...
boxplot(externals$number_of_comments, internals$number_of_comments, ylim=c(0, 15), xlab="# Occurrences", las = 1, outline = FALSE, cex.lab=2, cex.axis = 1.5, horizontal = TRUE, margin = list(l = 10, r = 10, b = 0, t = 0), col=(c("#E6E6E6", "#727272")))
...
# 1000, 750
dev.copy2eps(file="Images/number_of_comments.eps", width = 10, height = 7.5)
dev.off()
