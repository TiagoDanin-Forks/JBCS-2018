...
boxplot(externals$number_of_days, internals$number_of_days, xlab="# Occurrences", las = 1, outline = FALSE, cex.lab=1.5, cex.axis = 1.5, horizontal = TRUE, margin = list(l = 10, r = 10, b = 0, t = 0), col=(c("#E6E6E6","#727272")))
legend("top", xpd = TRUE, inset = c(-0.17,-0.17), bty = "n", legend=c("Internals", "Externals"), fill=c("#727272", "#E6E6E6"), cex=1.2, ncol=2)
dev.copy2eps(file="Images/linguist/linguist_days_amount.eps", width = 6.5, height = 3.6)
dev.off()

boxplot(externals$number_of_commits, internals$number_of_commits, ylim=c(0,17), lab="# Occurrences", las = 1, outline = FALSE, cex.lab=1.5, cex.axis = 1.5, horizontal = TRUE, margin = list(l = 10, r = 10, b = 0, t = 0), col=(c("#E6E6E6", "#727272")))
legend("top", xpd = TRUE, inset = c(-0.17,-0.17), bty = "n", legend=c("Internals", "Externals"), fill=c("#727272", "#E6E6E6"), cex=1.2, ncol=2)
dev.copy2eps(file="Images/linguist/linguist_commits_amount.eps", width = 6.5, height = 3.6) 
dev.off()

boxplot(externals$number_of_comments, internals$number_of_comments, ylim=c(0, 15), xlab="# Occurrences", las = 1, outline = FALSE, cex.lab=1.5, cex.axis = 1.5, horizontal = TRUE, margin = list(l = 10, r = 10, b = 0, t = 0), col=(c("#E6E6E6", "#727272")))
legend("top", xpd = TRUE, inset = c(-0.17,-0.17), bty = "n", legend=c("Internals", "Externals"), fill=c("#727272", "#E6E6E6"), cex=1.2, ncol=2)
...
boxplot(externals_sum$freq, internals_sum$freq, ylim=c(0, 103), xlab="# Occurrences", las = 1, outline = FALSE, cex.lab=1.5, cex.axis = 1.5, horizontal = TRUE, margin = list(l = 10, r = 10, b = 0, t = 0), col=(c("#E6E6E6", "#727272")))
legend("top", xpd = TRUE, inset = c(-0.17,-0.17), bty = "n", legend=c("Internals", "Externals"), fill=c("#727272", "#E6E6E6"), cex=1.2, ncol=2)
...
boxplot(externals$number_of_additions, internals$number_of_additions, externals$number_of_deletions, internals$number_of_deletions, externals$number_of_files_changed, internals$number_of_files_changed, ylim=c(0, 400), xlab="# Occurrences", las = 1, outline = FALSE, cex.lab=1.5, cex.axis = 1.5, horizontal = TRUE, margin = list(l = 10, r = 10, b = 0, t = 0), at = c(1,2,4,5,7,8), col=(c("#E6E6E6", "#727272", "#E6E6E6", "#727272", "#E6E6E6", "#727272")))
mtext("Additions", side=2, at=1.5, las=1, outer=FALSE, adj=1.2, cex=1.5)
mtext("Deletions", side=2, at=4.5, las=1, outer=FALSE, adj=1.2, cex=1.5)
mtext("Files Changed", side=2, at=7.5, las=1, outer=FALSE, adj=1.1, cex=1.5)
